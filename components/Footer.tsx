      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-sm">
        ...
        <div>
          ...
          <p className="text-gray-400">
            JK Career Updates provides latest government & private job notifications,
            syllabus, admit cards and results for Jammu & Kashmir.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/govt-jobs" className="hover:text-white">Govt Jobs</Link></li>
