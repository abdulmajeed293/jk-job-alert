      ...
      <div className="bg-gray-50 min-h-screen flex items-center justify-center px-4">
        <div className="bg-white p-8 rounded-2xl shadow-lg max-w-xl text-center">
          ...
          <p className="mt-4 text-gray-600">
            The last date to apply for this job has passed. Please check the
            latest job updates on JK Career Updates.
          </p>
          <Link
            href="/"
      ...
      <div className="max-w-6xl mx-auto px-4 grid gap-8">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4">
            {job.links.apply && (
              <a
                ...
                className="flex-1 text-center bg-blue-600 text-white py-3 rounded-xl font-semibold shadow hover:bg-blue-700 transition"
              >
                Apply Online
              </a>
            )}
        ...
        {job.introduction && (
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-all duration-300">
            ...
            <div
              ...
              [&_tr:nth-child(even)]:bg-blue-500 text-white
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-5">
          <Stat
            ...
            value={formatDate(job.dates.notification)}
          />
        ...
        <Section title="Eligibility">
          <p>
            <b>Qualification:</b> {job.eligibility.qualification}
          </p>
          <p>
            <b>Age Limit:</b> {job.eligibility.ageLimit}
          </p>
          <p>
            <b>Age Relaxation:</b> {job.eligibility.ageRelaxation}
          </p>
        </Section>
        ...
        <Section title="Important Links">
          <div className="flex flex-col gap-2 text-blue-600 font-medium">
            {job.links.apply && <a href={job.links.apply}>Apply Online</a>}
        ...
        <p className="text-xs text-gray-400 text-center mt-5">
          ...
          organization. Always verify details from the official website.
        </p>
      </div>
    </article>
  );
